...
abstract class AbstractBilling implements Billing
{
    ...
    public function create($authorized, array $options)
    {
        if ($authorized instanceof Shopify) {
            ...
            throw new \InvalidArgumentException('Argumant must be an instance of Shopify or Laravel\Socialite\Two\User');
        }
    ...
    public function getAllCharges($myshopify, $token, $sinceId = null)
    {
        ...
        if ($sinceId != null && $this->chargeType == 'application_charge') {
            ...
            $url = $this->getChargeEndpoint().'.json';
        }
    ...
    public function getCharge()
    {
        if ($this->charge != null) {
            ...
            throw new Exception('Charge must be created first');
        }
    }
    ...
    public function getActivated()
    {
        if ($this->activated != null) {
            ...
            throw new Exception('Charge must be activated');
        }
    }
